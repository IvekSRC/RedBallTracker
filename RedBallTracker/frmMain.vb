...
Public Class frmMain
    ...
    Sub ProcessFrameAndUpdateGUI(sender As Object, arg As EventArgs)
        ...
        For Each circle As CircleF In circles                         'for each circle
            ...
            txtXYRadius.AppendText("ball position x = " + circle.Center.X.ToString().PadLeft(4) + ", y = " +
                                   circle.Center.Y.ToString().PadLeft(4) + ", radius = " + circle.Radius.ToString("###.000").PadLeft(7))
